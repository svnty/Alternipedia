export default function Home() {
  return (
    <div className="relative bg-white">
      <div className="w-[934px] h-0 left-[493px] top-[195px] absolute outline outline-1 outline-offset-[-0.50px] outline-zinc-300" />
      <div className="size- left-[493px] top-[157px] absolute inline-flex justify-start items-start">
        <div data-property-1="Default" className="size- p-1.5 border-b-2 border-blue-400 flex justify-start items-center gap-1.5">
          <div className="size- flex justify-start items-center gap-1.5">
            <div data-svg-wrapper data-property-1="Read" className="relative">
              <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M12.1334 6.5C7.98184 6.5 4.43643 9.08225 3 12.7273C4.43643 16.3723 7.98184 18.9546 12.1334 18.9546C16.2849 18.9546 19.8303 16.3723 21.2667 12.7273C19.8303 9.08225 16.2849 6.5 12.1334 6.5ZM12.1334 16.8788C9.84172 16.8788 7.98184 15.0189 7.98184 12.7273C7.98184 10.4357 9.84172 8.57576 12.1334 8.57576C14.425 8.57576 16.2849 10.4357 16.2849 12.7273C16.2849 15.0189 14.425 16.8788 12.1334 16.8788ZM12.1334 10.2364C10.7551 10.2364 9.64245 11.349 9.64245 12.7273C9.64245 14.1056 10.7551 15.2182 12.1334 15.2182C13.5117 15.2182 14.6243 14.1056 14.6243 12.7273C14.6243 11.349 13.5117 10.2364 12.1334 10.2364Z" fill="#5F96CD" />
              </svg>
            </div>
            <div className="size- pr-1.5 flex justify-start items-center gap-2.5">
              <div className="justify-start text-blue-400 text-sm font-normal  leading-normal">Read</div>
            </div>
          </div>
        </div>
        <div data-property-1="Default" className="size- p-1.5 flex justify-start items-center gap-1.5">
          <div className="size- flex justify-start items-center gap-1.5">
            <div data-svg-wrapper data-property-1="Edit" className="relative">
              <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M5 17.3753V19.8716C5 20.1015 5.18065 20.2821 5.41057 20.2821H7.90683C8.01357 20.2821 8.12032 20.2411 8.19422 20.159L17.161 11.2004L14.0818 8.12109L5.12317 17.0797C5.04106 17.1618 5 17.2604 5 17.3753Z" fill="#B0B6C1" />
                <path d="M19.5429 7.66164L17.6214 5.74018C17.3012 5.41994 16.7839 5.41994 16.4636 5.74018L14.9609 7.24286L18.0402 10.3221L19.5429 8.81945C19.8631 8.4992 19.8631 7.98189 19.5429 7.66164Z" fill="#B0B6C1" />
              </svg>
            </div>
            <div className="size- pr-1.5 flex justify-start items-center gap-2.5">
              <div className="justify-start text-gray-400 text-sm font-normal  leading-normal">Edit</div>
            </div>
          </div>
        </div>
        <div data-property-1="Default" className="size- p-1.5 flex justify-start items-center gap-1.5">
          <div className="size- flex justify-start items-center gap-1.5">
            <div data-svg-wrapper data-property-1="History" className="relative">
              <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M13.3106 4.50312C8.76741 4.37815 5.04537 8.02879 5.04537 12.5363H3.44766C3.046 12.5363 2.84963 13.0183 3.13526 13.295L5.62554 15.7942C5.80406 15.9727 6.08076 15.9727 6.25927 15.7942L8.74956 13.295C9.02626 13.0183 8.82989 12.5363 8.42823 12.5363H6.83052C6.83052 9.05525 9.66891 6.24364 13.1678 6.28827C16.4882 6.3329 19.282 9.12666 19.3266 12.447C19.3712 15.937 16.5596 18.7843 13.0786 18.7843C11.6415 18.7843 10.3116 18.2934 9.25833 17.4633C8.9013 17.1866 8.40145 17.2134 8.08013 17.5347C7.70524 17.9096 7.73202 18.5433 8.15153 18.8647C9.50825 19.9358 11.2131 20.5695 13.0786 20.5695C17.5861 20.5695 21.2367 16.8474 21.1117 12.3042C20.9957 8.11805 17.4968 4.61915 13.3106 4.50312ZM12.8554 8.96599C12.4895 8.96599 12.186 9.26947 12.186 9.63543V12.9201C12.186 13.2325 12.3556 13.5271 12.6233 13.6877L15.4082 15.339C15.7295 15.5264 16.1401 15.4193 16.3275 15.1069C16.515 14.7856 16.4079 14.375 16.0955 14.1876L13.5248 12.6613V9.6265C13.5248 9.26947 13.2214 8.96599 12.8554 8.96599Z" fill="#B0B6C1" />
              </svg>
            </div>
            <div className="size- pr-1.5 flex justify-start items-center gap-2.5">
              <div className="justify-start text-gray-400 text-sm font-normal  leading-normal">History</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="w-[1920px] h-56 left-0 top-[3172px] absolute">
        <div className="w-[1920px] h-56 left-0 top-0 absolute bg-white" />
        <div data-svg-wrapper className="left-0 top-0 absolute">
          <svg width="1920" height="2" viewBox="0 0 1920 2" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M0 1H1920" stroke="#D3D5D9" />
          </svg>
        </div>
        <div className="w-[528px] left-[160px] top-[38px] absolute justify-start"><span class="text-neutral-800 text-sm font-normal  leading-normal">Text is available under the </span><span class="text-blue-400 text-sm font-normal  leading-normal">Creative Commons Attribution-ShareAlike License 4.0</span><span class="text-neutral-800 text-sm font-normal  leading-normal">; additional terms may apply. By using this site, you agree to the </span><span class="text-blue-400 text-sm font-normal  leading-normal">Terms of Use</span><span class="text-blue-400 text-sm font-normal  leading-normal"> </span><span class="text-neutral-800 text-sm font-normal  leading-normal">and </span><span class="text-blue-400 text-sm font-normal  leading-normal">Privacy Policy</span><span class="text-neutral-800 text-sm font-normal  leading-normal">. Wikipedia® is a registered trademark of the </span><span class="text-blue-400 text-sm font-normal  leading-normal">Wikimedia Foundation, Inc.</span><span class="text-neutral-800 text-sm font-normal  leading-normal">, a non-profit organization.</span></div>
        <div className="size- left-[794px] top-[38px] absolute inline-flex flex-col justify-start items-start">
          <div className="justify-start text-blue-400 text-sm font-normal  leading-normal">About Wikipedia</div>
          <div className="justify-start text-blue-400 text-sm font-normal  leading-normal">Contact Wikipedia</div>
          <div className="justify-start text-blue-400 text-sm font-normal  leading-normal">Privacy policy</div>
          <div className="justify-start text-blue-400 text-sm font-normal  leading-normal">Disclaimers</div>
          <div className="justify-start text-blue-400 text-sm font-normal  leading-normal">Code of Conduct</div>
        </div>
        <div className="size- left-[1007px] top-[38px] absolute inline-flex flex-col justify-start items-start">
          <div className="justify-start text-blue-400 text-sm font-normal  leading-normal">Developers</div>
          <div className="justify-start text-blue-400 text-sm font-normal  leading-normal">Statistics</div>
          <div className="justify-start text-blue-400 text-sm font-normal  leading-normal">Mobile view</div>
          <div className="justify-start text-blue-400 text-sm font-normal  leading-normal">Cookie statement</div>
        </div>
        <img className="w-28 h-10 left-[1640px] top-[38px] absolute" src="https://placehold.co/120x42" />
      ...
      <div className="w-64 h-[2476px] left-[160px] top-[159px] absolute overflow-hidden">
        <div className="w-64 h-[748px] left-0 top-[-84px] absolute overflow-hidden">
          <div className="size- left-0 top-[84px] absolute inline-flex flex-col justify-start items-start gap-5">
            <div data-property-1="Default" className="w-64 h-40 relative overflow-hidden">
              <div className="w-64 left-0 top-0 absolute inline-flex flex-col justify-start items-start gap-5">
                ...
                <div className="self-stretch flex flex-col justify-start items-start gap-2.5">
                  <div className="self-stretch inline-flex justify-between items-start">
                    <div className="flex-1 justify-start text-gray-500 text-sm font-normal  leading-normal">Senses</div>
                    <div data-svg-wrapper data-property-1="Arrow Right" className="relative">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M9.21984 15.153L12.5505 11.8224L9.21984 8.49172C8.88505 8.15694 8.88505 7.61614 9.21984 7.28136C9.55462 6.94658 10.0954 6.94658 10.4302 7.28136L14.3703 11.2215C14.7051 11.5563 14.7051 12.0971 14.3703 12.4318L10.4302 16.372C10.0954 16.7067 9.55462 16.7067 9.21984 16.372C8.89364 16.0372 8.88505 15.4878 9.21984 15.153Z" fill="var(--Text---Secondary, #636C7E)" />
                      </svg>
                    </div>
                  </div>
                  <div className="self-stretch inline-flex justify-between items-start">
                    <div className="flex-1 justify-start text-gray-500 text-sm font-normal  leading-normal">Behavior</div>
                    <div data-svg-wrapper data-property-1="Arrow Right" className="relative">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M9.21984 15.153L12.5505 11.8224L9.21984 8.49172C8.88505 8.15694 8.88505 7.61614 9.21984 7.28136C9.55462 6.94658 10.0954 6.94658 10.4302 7.28136L14.3703 11.2215C14.7051 11.5563 14.7051 12.0971 14.3703 12.4318L10.4302 16.372C10.0954 16.7067 9.55462 16.7067 9.21984 16.372C8.89364 16.0372 8.88505 15.4878 9.21984 15.153Z" fill="var(--Text---Secondary, #636C7E)" />
                      </svg>
                  ...
                  <div className="self-stretch inline-flex justify-between items-start">
                    <div className="flex-1 justify-start text-gray-500 text-sm font-normal  leading-normal">See also</div>
                  </div>
                </div>
                <div data-svg-wrapper className="left-[-2px] top-[36px] absolute">
                  <svg width="253" height="2" viewBox="0 0 253 2" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M-2 1H253" stroke="#D3D5D9" />
                  </svg>
                </div>
              </div>
            </div>
      ...
      <div className="size- left-[493px] top-[109px] absolute inline-flex justify-start items-end gap-[5px]">
        <div data-svg-wrapper data-property-1="Article" className="relative">
          <svg width="29" height="29" viewBox="0 0 29 29" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M10.242 18.6994H14.9411C15.2074 18.6994 15.4308 18.6092 15.6112 18.4287C15.791 18.2489 15.8809 18.0259 15.8809 17.7596C15.8809 17.4933 15.791 17.2699 15.6112 17.0895C15.4308 16.9097 15.2074 16.8198 14.9411 16.8198H10.242C9.97576 16.8198 9.7524 16.9097 9.57196 17.0895C9.39214 17.2699 9.30223 17.4933 9.30223 17.7596C9.30223 18.0259 9.39214 18.2489 9.57196 18.4287C9.7524 18.6092 9.97576 18.6994 10.242 18.6994ZM10.242 14.9401H17.7606C18.0268 14.9401 18.2499 14.8499 18.4297 14.6695C18.6102 14.4897 18.7004 14.2666 18.7004 14.0003C18.7004 13.734 18.6102 13.5107 18.4297 13.3302C18.2499 13.1504 18.0268 13.0605 17.7606 13.0605H10.242C9.97576 13.0605 9.7524 13.1504 9.57196 13.3302C9.39214 13.5107 9.30223 13.734 9.30223 14.0003C9.30223 14.2666 9.39214 14.4897 9.57196 14.6695C9.7524 14.8499 9.97576 14.9401 10.242 14.9401ZM10.242 11.1809H17.7606C18.0268 11.1809 18.2499 11.0907 18.4297 10.9102C18.6102 10.7304 18.7004 10.5073 18.7004 10.2411C18.7004 9.97479 18.6102 9.75142 18.4297 9.57098C18.2499 9.39116 18.0268 9.30125 17.7606 9.30125H10.242C9.97576 9.30125 9.7524 9.39116 9.57196 9.57098C9.39214 9.75142 9.30223 9.97479 9.30223 10.2411C9.30223 10.5073 9.39214 10.7304 9.57196 10.9102C9.7524 11.0907 9.97576 11.1809 10.242 11.1809ZM7.4226 22.4587C6.9057 22.4587 6.46305 22.2748 6.09464 21.907C5.72686 21.5386 5.54297 21.0959 5.54297 20.579V7.42162C5.54297 6.90472 5.72686 6.46207 6.09464 6.09366C6.46305 5.72588 6.9057 5.54199 7.4226 5.54199H20.58C21.0969 5.54199 21.5396 5.72588 21.908 6.09366C22.2757 6.46207 22.4596 6.90472 22.4596 7.42162V20.579C22.4596 21.0959 22.2757 21.5386 21.908 21.907C21.5396 22.2748 21.0969 22.4587 20.58 22.4587H7.4226ZM7.4226 20.579H20.58V7.42162H7.4226V20.579Z" fill="#202122" />
          </svg>
        </div>
        <div className="justify-start text-neutral-800 text-3xl font-normal ">Cat</div>
      </div>
      <div className="w-[928px] left-[499px] top-[235px] absolute inline-flex flex-col justify-start items-start gap-12">
        <div className="self-stretch inline-flex justify-start items-start gap-12">
          <div className="flex-1 inline-flex flex-col justify-start items-center gap-7">
            <div className="self-stretch justify-start"><span class="text-neutral-800 text-base font-normal  leading-7">The </span><span class="text-neutral-800 text-base font-bold  leading-7">cat (Felis catus)</span><span class="text-neutral-800 text-base font-normal  leading-7">, commonly referred to as</span><span class="text-neutral-800 text-base font-bold  leading-7"> the domestic cat</span><span class="text-neutral-800 text-base font-normal  leading-7"> or </span><span class="text-neutral-800 text-base font-bold  leading-7">house cat</span><span class="text-neutral-800 text-base font-normal  leading-7">, is the only </span><span class="text-blue-400 text-base font-normal  leading-7">domesticated species</span><span class="text-neutral-800 text-base font-normal  leading-7"> in the family </span><span class="text-blue-400 text-base font-normal  leading-7">Felidae</span><span class="text-neutral-800 text-base font-normal  leading-7">. Recent advances in </span><span class="text-blue-400 text-base font-normal  leading-7">archaeology</span><span class="text-neutral-800 text-base font-normal  leading-7"> and</span><span class="text-blue-400 text-base font-normal  leading-7"> genetics </span><span class="text-neutral-800 text-base font-normal  leading-7">have shown that the </span><span class="text-blue-400 text-base font-normal  leading-7">domestication of the cat</span><span class="text-neutral-800 text-base font-normal  leading-7"> occurred in the</span><span class="text-blue-400 text-base font-normal  leading-7"> Near East</span><span class="text-neutral-800 text-base font-normal  leading-7"> around 7500</span><span class="text-blue-400 text-base font-normal  leading-7"> BC</span><span class="text-neutral-800 text-base font-normal  leading-7">. It is commonly kept as a </span><span class="text-blue-400 text-base font-normal  leading-7">house pet</span><span class="text-neutral-800 text-base font-normal  leading-7"> and </span><span class="text-blue-400 text-base font-normal  leading-7">farm cat</span><span class="text-neutral-800 text-base font-normal  leading-7">, but also ranges freely as a </span><span class="text-blue-400 text-base font-normal  leading-7">feral cat</span><span class="text-neutral-800 text-base font-normal  leading-7"> avoiding human contact. It is valued by humans for companionship and its ability to kill </span><span class="text-blue-400 text-base font-normal  leading-7">vermin</span><span class="text-neutral-800 text-base font-normal  leading-7">. Its retractable</span><span class="text-blue-400 text-base font-normal  leading-7"> claws</span><span class="text-neutral-800 text-base font-normal  leading-7"> are adapted to killing </span><span class="text-blue-400 text-base font-normal  leading-7">small prey</span><span class="text-neutral-800 text-base font-normal  leading-7"> like</span><span class="text-blue-400 text-base font-normal  leading-7"> mice</span><span class="text-neutral-800 text-base font-normal  leading-7"> and </span><span class="text-blue-400 text-base font-normal  leading-7">rats</span><span class="text-neutral-800 text-base font-normal  leading-7">. It has a strong, flexible body, quick</span><span class="text-blue-400 text-base font-normal  leading-7"> reflexes</span><span class="text-neutral-800 text-base font-normal  leading-7">, sharp teeth, and its </span><span class="text-blue-400 text-base font-normal  leading-7">night vision </span><span class="text-neutral-800 text-base font-normal  leading-7">and</span><span class="text-blue-400 text-base font-normal  leading-7"> sense of smell </span><span class="text-neutral-800 text-base font-normal  leading-7">are well developed. It is a </span><span class="text-blue-400 text-base font-normal  leading-7">social species</span><span class="text-neutral-800 text-base font-normal  leading-7">, but a solitary hunter and a </span><span class="text-blue-400 text-base font-normal  leading-7">crepuscular predator</span><span class="text-neutral-800 text-base font-normal  leading-7">. </span><span class="text-blue-400 text-base font-normal  leading-7">Cat communication</span><span class="text-neutral-800 text-base font-normal  leading-7"> includes vocalizations like </span><span class="text-blue-400 text-base font-normal  leading-7">meowing</span><span class="text-neutral-800 text-base font-normal  leading-7">,</span><span class="text-blue-400 text-base font-normal  leading-7"> purring</span><span class="text-neutral-800 text-base font-normal  leading-7">, trilling, hissing, </span><span class="text-blue-400 text-base font-normal  leading-7">growling</span><span class="text-neutral-800 text-base font-normal  leading-7">, and grunting as well as </span><span class="text-blue-400 text-base font-normal  leading-7">cat body language</span><span class="text-neutral-800 text-base font-normal  leading-7">. It can hear sounds too faint or too high in </span><span class="text-blue-400 text-base font-normal  leading-7">frequency</span><span class="text-neutral-800 text-base font-normal  leading-7"> for </span><span class="text-blue-400 text-base font-normal  leading-7">human ears</span><span class="text-neutral-800 text-base font-normal  leading-7">, such as those made by </span><span class="text-blue-400 text-base font-normal  leading-7">small mammals</span><span class="text-neutral-800 text-base font-normal  leading-7">. It also secretes and perceives </span><span class="text-blue-400 text-base font-normal  leading-7">pheromones</span><span class="text-neutral-800 text-base font-normal  leading-7">.</span></div>
            <div className="self-stretch justify-start"><span class="text-neutral-800 text-base font-normal  leading-7">Female domestic cats can have</span><span class="text-blue-400 text-base font-normal  leading-7"> </span><span class="text-blue-400 text-base font-normal  leading-7">kittens</span><span class="text-neutral-800 text-base font-normal  leading-7"> from </span><span class="text-blue-400 text-base font-normal  leading-7">spring</span><span class="text-neutral-800 text-base font-normal  leading-7"> to late </span><span class="text-blue-400 text-base font-normal  leading-7">autumn</span><span class="text-neutral-800 text-base font-normal  leading-7"> in </span><span class="text-blue-400 text-base font-normal  leading-7">temperate zones</span><span class="text-neutral-800 text-base font-normal  leading-7"> and throughout the year in </span><span class="text-blue-400 text-base font-normal  leading-7">equatorial regions</span><span class="text-neutral-800 text-base font-normal  leading-7">, with</span><span class="text-blue-400 text-base font-normal  leading-7"> </span><span class="text-blue-400 text-base font-normal  leading-7">litter</span><span class="text-neutral-800 text-base font-normal  leading-7"> sizes often ranging from two to five kittens. Domestic cats are bred and shown at events as registered </span><span class="text-blue-400 text-base font-normal  leading-7">pedigreed cats</span><span class="text-neutral-800 text-base font-normal  leading-7">, a hobby known as </span><span class="text-blue-400 text-base font-normal  leading-7">cat fancy</span><span class="text-neutral-800 text-base font-normal  leading-7">. </span><span class="text-blue-400 text-base font-normal  leading-7">Animal population control</span><span class="text-neutral-800 text-base font-normal  leading-7"> of cats may be achieved by</span><span class="text-blue-400 text-base font-normal  leading-7"> </span><span class="text-blue-400 text-base font-normal  leading-7">spaying</span><span class="text-neutral-800 text-base font-normal  leading-7"> and </span><span class="text-blue-400 text-base font-normal  leading-7">neutering</span><span class="text-neutral-800 text-base font-normal  leading-7">, but their proliferation and the abandonment of pets has resulted in large numbers of feral cats worldwide, contributing to the extinction of</span><span class="text-blue-400 text-base font-normal  leading-7"> </span><span class="text-blue-400 text-base font-normal  leading-7">bird</span><span class="text-neutral-800 text-base font-normal  leading-7">, </span><span class="text-blue-400 text-base font-normal  leading-7">mammal</span><span class="text-blue-400 text-base font-normal  leading-7"> </span><span class="text-neutral-800 text-base font-normal  leading-7">and</span><span class="text-blue-400 text-base font-normal  leading-7"> </span><span class="text-blue-400 text-base font-normal  leading-7">reptile</span><span class="text-neutral-800 text-base font-normal  leading-7"> species.</span></div>
            <div className="self-stretch justify-start"><span class="text-neutral-800 text-base font-normal  leading-7">As of 2017, the domestic cat was the second most popular pet in the </span><span class="text-blue-400 text-base font-normal  leading-7">United States</span><span class="text-neutral-800 text-base font-normal  leading-7">, with 95.6 million cats owned and around 42 million households owning at least one cat. In the </span><span class="text-blue-400 text-base font-normal  leading-7">United Kingdom</span><span class="text-neutral-800 text-base font-normal  leading-7">, 26% of adults have a cat, with an estimated population of 10.9 million pet cats as of 2020. As of 2021, there were an estimated 220 million owned and 480 million stray cats in the world.</span></div>
          </div>
          <div className="size- p-2.5 bg-white rounded-md outline outline-1 outline-offset-[-1px] outline-gray-100 inline-flex flex-col justify-start items-start gap-3.5">
            <div className="self-stretch justify-start text-neutral-800 text-lg font-bold  leading-loose">Cat</div>
            <div className="w-64 inline-flex justify-start items-start gap-2.5 flex-wrap content-start">
        ...
        <div className="self-stretch flex flex-col justify-start items-center gap-5">
          ...
          <div className="self-stretch inline-flex justify-center items-start gap-5">
            <div className="flex-1 justify-start"><span class="text-neutral-800 text-base font-normal  leading-7">Cats have excellent </span><span class="text-neutral-800 text-base font-normal  leading-7">night vision</span><span class="text-neutral-800 text-base font-normal  leading-7"> and can see at one sixth the light level required for human vision.</span><sup class="text-blue-400 text-base font-normal  leading-7">[51]</sup><sup class="text-blue-400 text-base font-normal  leading-7">: 43</sup><span class="text-blue-400 text-base font-normal  leading-7"> </span><span class="text-neutral-800 text-base font-normal  leading-7"> This is partly the result of cat eyes having a </span><span class="text-blue-400 text-base font-normal  leading-7">tapetum lucidum</span><span class="text-neutral-800 text-base font-normal  leading-7">, which reflects any light that passes through the </span><span class="text-blue-400 text-base font-normal  leading-7">retina</span><span class="text-neutral-800 text-base font-normal  leading-7"> back into the eye, thereby increasing the eye's sensitivity to dim light.</span><sup class="text-blue-400 text-base font-normal  leading-7">[67]</sup><span class="text-neutral-800 text-base font-normal  leading-7"> Large pupils are an adaptation to dim light. The domestic cat has </span><span class="text-blue-400 text-base font-normal  leading-7">slit pupils</span><span class="text-neutral-800 text-base font-normal  leading-7">, which allow it to focus bright light without</span><span class="text-blue-400 text-base font-normal  leading-7"> </span><span class="text-blue-400 text-base font-normal  leading-7">chromatic aberration</span><span class="text-neutral-800 text-base font-normal  leading-7">.</span><sup class="text-blue-400 text-base font-normal  leading-7">[68]</sup><span class="text-neutral-800 text-base font-normal  leading-7"> At low light, a cat's pupils expand to cover most of the exposed surface of its eyes.</span><sup class="text-blue-400 text-base font-normal  leading-7">[69]</sup><span class="text-neutral-800 text-base font-normal  leading-7"> The domestic cat has rather poor</span><span class="text-blue-400 text-base font-normal  leading-7"> </span><span class="text-blue-400 text-base font-normal  leading-7">color vision</span><span class="text-neutral-800 text-base font-normal  leading-7"> and only two types of </span><span class="text-blue-400 text-base font-normal  leading-7">cone cells</span><span class="text-neutral-800 text-base font-normal  leading-7">, optimized for sensitivity to blue and yellowish green; its ability to distinguish between red and green is limited.</span><sup class="text-blue-400 text-base font-normal  leading-7">[70]</sup><span class="text-neutral-800 text-base font-normal  leading-7"> A response to middle wavelengths from a system other than the</span><span class="text-blue-400 text-base font-normal  leading-7"> </span><span class="text-blue-400 text-base font-normal  leading-7">rod cells</span><span class="text-neutral-800 text-base font-normal  leading-7"> might be due to a third type of cone. This appears to be an adaptation to low light levels rather than representing true </span><span class="text-neutral-800 text-base font-normal  leading-7">trichromatic</span><span class="text-neutral-800 text-base font-normal  leading-7"> vision.</span><sup class="text-blue-400 text-base font-normal  leading-7">[71]</sup><span class="text-neutral-800 text-base font-normal  leading-7"> Cats also have a </span><span class="text-blue-400 text-base font-normal  leading-7">nictitating membrane</span><span class="text-neutral-800 text-base font-normal  leading-7">, allowing them to blink without hindering their vision.</span></div>
            <div className="size- p-2.5 bg-gray-100 rounded-md inline-flex flex-col justify-start items-start gap-3.5">
              <img className="w-64 h-48" src="https://placehold.co/251x189" />
              <div className="w-64 justify-start"><span class="text-neutral-800 text-sm font-normal  leading-normal">Reflection of camera flash from the </span><span class="text-blue-400 text-sm font-normal  leading-normal">tapetum lucidum</span></div>
            </div>
          </div>
          <div className="self-stretch flex flex-col justify-start items-start gap-2.5">
            <div className="size- inline-flex justify-start items-center gap-0.5">
          ...
          <div className="self-stretch inline-flex justify-center items-start gap-5">
            <div className="flex-1 flex justify-center items-start gap-5">
              <div className="flex-1 justify-start"><span class="text-neutral-800 text-base font-normal  leading-7">The domestic cat's hearing is most acute in the range of 500 Hz to 32 kHz.</span><sup class="text-blue-400 text-base font-normal  leading-7">[72]</sup><sup class="text-blue-400 text-base font-normal  leading-7"> </sup><span class="text-neutral-800 text-base font-normal  leading-7">It can detect an extremely broad range of frequencies ranging from 55 Hz to 79 kHz, whereas humans can only detect frequencies between 20 Hz and 20 kHz. It can hear a range of 10.5 </span><span class="text-blue-400 text-base font-normal  leading-7">octaves</span><span class="text-neutral-800 text-base font-normal  leading-7">, while humans and dogs can hear ranges of about 9 octaves.</span><sup class="text-blue-400 text-base font-normal  leading-7">[73]</sup><sup class="text-blue-400 text-base font-normal  leading-7">[74]</sup><span class="text-neutral-800 text-base font-normal  leading-7"> Its hearing sensitivity is enhanced by its large movable outer ears, the </span><span class="text-blue-400 text-base font-normal  leading-7">pinnae</span><span class="text-neutral-800 text-base font-normal  leading-7">, which amplify sounds and help detect the location of a noise. It can detect </span><span class="text-blue-400 text-base font-normal  leading-7">ultrasound</span><span class="text-neutral-800 text-base font-normal  leading-7">, which enables it to detect ultrasonic calls made by </span><span class="text-blue-400 text-base font-normal  leading-7">rodent</span><span class="text-neutral-800 text-base font-normal  leading-7"> prey.</span><sup class="text-blue-400 text-base font-normal  leading-7">[75]</sup><sup class="text-blue-400 text-base font-normal  leading-7">[76]</sup><span class="text-neutral-800 text-base font-normal  leading-7"> Recent research has shown that cats have socio-spatial cognitive abilities to create mental maps of owners' locations based on hearing owners' voices.</span><sup class="text-blue-400 text-base font-normal  leading-7">[77]</sup></div>
            </div>
            <div className="size- p-2.5 bg-gray-100 rounded-md inline-flex flex-col justify-start items-start gap-3.5">
              <img className="w-64 h-72" src="https://placehold.co/251x277" />
          ...
          <div className="self-stretch inline-flex justify-center items-start gap-5">
            <div className="flex-1 flex justify-center items-start gap-5">
              <div className="flex-1 inline-flex flex-col justify-start items-center gap-5">
                <div className="self-stretch justify-start"><span class="text-neutral-800 text-base font-normal  leading-7">Outdoor cats are active both day and night, although they tend to be slightly more active at night.</span><span class="text-blue-400 text-base font-normal  leading-7">[89]</span><span class="text-blue-400 text-base font-normal  leading-7"> </span><span class="text-neutral-800 text-base font-normal  leading-7">Domestic cats spend the majority of their time in the vicinity of their homes but can range many hundreds of meters from this central point. They establish </span><span class="text-blue-400 text-base font-normal  leading-7">territories</span><span class="text-neutral-800 text-base font-normal  leading-7"> that vary considerably in size, in one study ranging 7–28 ha (17–69 acres).</span><sup class="text-blue-400 text-base font-normal  leading-7">[90]</sup><span class="text-neutral-800 text-base font-normal  leading-7"> The timing of cats' activity is quite flexible and varied but being low-light predators, they are generally </span><span class="text-blue-400 text-base font-normal  leading-7">crepuscular</span><span class="text-neutral-800 text-base font-normal  leading-7">, which means they tend to be more active near dawn and dusk. However, house cats' behavior is also influenced by human activity and they may adapt to their owners' sleeping patterns to some extent.</span><sup class="text-blue-400 text-base font-normal  leading-7">[91]</sup><sup class="text-blue-400 text-base font-normal  leading-7">[92]</sup></div>
                <div className="self-stretch justify-start"><span class="text-neutral-800 text-base font-normal  leading-7">Cats conserve energy by sleeping more than most animals, especially as they grow older. The daily duration of sleep varies, usually between 12 and 16 hours, with 13 and 14 being the average. Some cats can sleep as much as 20 hours. The term "cat nap" for a short rest refers to the cat's tendency to fall asleep (lightly) for a brief period. While asleep, cats experience short periods of </span><span class="text-blue-400 text-base font-normal  leading-7">rapid eye movement sleep</span><span class="text-blue-400 text-base font-normal  leading-7"> </span><span class="text-neutral-800 text-base font-normal  leading-7">often accompanied by muscle twitches, which suggests they are dreaming.</span><sup class="text-blue-400 text-base font-normal  leading-7">[93]</sup></div>
              </div>
              <div className="size- p-2.5 bg-gray-100 rounded-md inline-flex flex-col justify-start items-start gap-3.5">
              ...
              <div className="w-7 self-stretch p-1.5 rounded-md flex justify-center items-center gap-1.5">
                <div className="size- flex justify-start items-center gap-1.5">
                  <div data-svg-wrapper data-property-1="Category" className="relative">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M5 8H15.9565" stroke="#D8753C" stroke-width="1.5" stroke-linecap="round" />
                      <path d="M8.65234 12.2607H19.0002" stroke="#D8753C" stroke-width="1.5" stroke-linecap="round" />
                      <path d="M5 12.2607H5.0001" stroke="#D8753C" stroke-width="1.5" stroke-linecap="round" />
                      <path d="M8.65234 16.5215H19.0002" stroke="#D8753C" stroke-width="1.5" stroke-linecap="round" />
                      <path d="M5 16.5215H5.0001" stroke="#D8753C" stroke-width="1.5" stroke-linecap="round" />
                    </svg>
                  </div>
                </div>
              </div>
      ...
      <div data-svg-wrapper className="left-[493px] top-[109.50px] absolute">
        <svg width="934" height="48" viewBox="0 0 934 48" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M0 47H725C730.523 47 735 42.5228 735 37V11.5C735 5.97715 739.477 1.5 745 1.5H832C837.523 1.5 842 5.97715 842 11.5V37C842 42.5228 846.477 47 852 47H934" stroke="#EDEFF2" stroke-width="2" />
        </svg>
      </div>
      <div className="left-[1258px] top-[118px] absolute justify-start text-neutral-800 text-base font-normal  leading-7">Article</div>
      <div className="left-[1366px] top-[118px] absolute justify-start text-gray-500 text-base font-normal  leading-7">Talk</div>


      <div className="size- p-3 left-[1760px] top-[950px] absolute origin-top-left rotate-90 bg-gray-100 rounded-[94px] inline-flex justify-start items-center gap-1.5">
        <div data-svg-wrapper data-property-1="Up" className="relative">
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M12.0013 6V18M12.0013 6L16.3555 10.3541M12.0013 6L7.64721 10.3541" stroke="#202122" stroke-width="1.67198" stroke-linecap="round" stroke-linejoin="round" />
          </svg>
        </div>
      </div>
    </div>
