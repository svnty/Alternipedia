...
// --- Icons ---
import { BoldIcon } from "@/app/(components)/ui/tiptap-icons/bold-icon"
import { Code2Icon } from "@/app/(components)/ui/tiptap-icons/code2-icon"
import { ItalicIcon } from "@/app/(components)/ui/tiptap-icons/italic-icon"
import { StrikeIcon } from "@/app/(components)/ui/tiptap-icons/strike-icon"
import { SubscriptIcon } from "@/app/(components)/ui/tiptap-icons/subscript-icon"
import { SuperscriptIcon } from "@/app/(components)/ui/tiptap-icons/superscript-icon"
import { UnderlineIcon } from "@/app/(components)/ui/tiptap-icons/underline-icon"
