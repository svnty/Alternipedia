...
/**
 * A Tiptap node view component for uploading video files.
 */
const VideoUploadNode = (props: NodeViewProps) => {
  ...
  if (!extension?.options?.upload) {
    return (
      <NodeViewWrapper>
        <div className="video-upload-node">
  ...
  if (src) {
    return (
      <NodeViewWrapper>
        <div className="video-upload-node">
          <video controls src={src} className="w-full max-h-96" />
      ...
      <div className="video-upload-node">
        ...
        >
          <div className="text-muted-foreground">
            <div className="text-lg font-medium mb-2">Upload Video</div>
            <div className="text-sm">
              Click to select a video file ({accept})
            </div>
            {maxSize > 0 && (
