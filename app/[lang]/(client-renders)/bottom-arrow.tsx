...
export default function BottomArrow() {
  return (
    <div className="fixed bottom-8 right-8 p-3 bg-gray-100 rounded-full shadow-lg hover:shadow-xl transition-shadow cursor-pointer lg:block hidden lg:z-20" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })} >
